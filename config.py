...
OWNER_ID = int(os.environ.get("OWNER_ID", "6676704302"))  # Your Telegram user ID
SUDO_USERS = list(map(int, os.environ.get("SUDO_USERS", "6024421380").split()))  # Space-separated user IDs
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002202621782"))  # Telegram channel ID (with -100 prefix)

PREMIUM_LOGS = os.environ.get("PREMIUM_LOGS", "-1002677660592")  # Optional here you'll get all logs
